...
{
    /**
     * @return array{title: string, catalogTabs: array<int, string>, catalogItems: array<int, array{name: string, tab: string, printType: string, minOrder: string, price: string, image: string, category: string, startingPrice: int, minimumOrderQuantity: int}>}
     */
    ...
    /**
     * @return array{title: string, catalogItems: array<int, array{name: string, tab: string, printType: string, minOrder: string, price: string, image: string, category: string, startingPrice: int, minimumOrderQuantity: int}>}
     */
    ...
    /**
     * @param  Collection<int, CatalogItem>  $catalogItems
     * @return array<int, array{name: string, tab: string, printType: string, minOrder: string, price: string, image: string, category: string, startingPrice: int, minimumOrderQuantity: int}>
     */
